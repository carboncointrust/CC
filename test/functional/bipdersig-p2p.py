...
class BIP66Test(CarboncoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # carboncoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and carboncoind produces more specific reject
            # reasons.
