...
# TestNode: A peer we use to send messages to carboncoind, and store responses.
...
class CompactBlocksTest(CarboncoinTestFramework):
    ...
    # This test actually causes carboncoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that carboncoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for carboncoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # carboncoind will not send blocktxn responses for blocks whose height is
