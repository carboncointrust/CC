...
from test_framework.test_framework import CarboncoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (CarboncoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that carboncoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("carboncoind has not been built with zmq enabled.")
