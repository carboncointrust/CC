...
#ifndef CARBONCOIN_WALLET_WALLET_H
#define CARBONCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this carboncoin node, and set to 0 for transactions that were created
...
#endif // CARBONCOIN_WALLET_WALLET_H
