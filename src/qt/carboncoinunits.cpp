...
QString CarboncoinUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
QString CarboncoinUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return format(unit, amount, plussign, separators) + QString(" ") + name(unit);
}

QString CarboncoinUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
...
bool CarboncoinUnits::parse(int unit, const QString &value, CAmount *val_out)
{
...
QString CarboncoinUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (CarboncoinUnits::valid(unit))
    {
        amountTitle += " ("+CarboncoinUnits::name(unit) + ")";
    }
    return amountTitle;
}
...
CAmount CarboncoinUnits::maxMoney()
{
    return MAX_MONEY;
}
