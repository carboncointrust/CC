...
#if defined(NDEBUG)
# error "Carboncoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Carboncoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CARBON additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("carboncoin-scriptch");
