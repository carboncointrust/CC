Carboncoin Core version 0.13.2 is now available from:

  <https://carboncoin.org/bin/carboncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update carboncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow carboncoin-tx to create v2 transactions (carbondrak)
