Carboncoin Core version 0.10.4 is now available from:

  <https://carboncoin.org/bin/carboncoin-core-0.10.4/>
...
- #6953 `43c2789` Split carboncoin-tx into its own package
- #6953 `dfe0d4d` Include carboncoin-tx binary on Debian/Ubuntu
