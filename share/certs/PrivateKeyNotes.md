...
unlocked to sign the Carboncoin-Qt.app bundle.
...
allowing somebody to distribute a Carboncoin-Qt.app or carboncoin-qt-setup.exe with a valid
...
that the carboncoin-qt.exe file inside the installer had not been tampered with.
